	...
	<div class="col-md-12">
		...
		<form method="post" action="" role="form">
		  <div class="form-group">
		    ...
		    <input type="email" name="email" class="form-control" id="exampleInputEmail1" placeholder="E-mail adresse" value="<?php echo issetOr($_POST['email'], $user['email']); ?>">
		  </div>
		  <div class="form-group">
		  ...
		  <?php foreach($groups as $group): ?>
			...
			<label class="checkbox-inline">
			  <input type="checkbox" name="groups[<?php echo $group['id']; ?>]" id="inlineCheckbox1" value="<?php echo $group['id']; ?>"<?php echo (issetOr($_POST['groups'][$group['id']], (in_array($group['id'], $has_groups)))) ? ' checked' : ''; ?>> <?php echo $group['name']; ?>
			</label>
